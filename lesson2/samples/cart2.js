...
// itemsList.fetchItems().then(() => {
//     itemsList.items.forEach(item => {
//         let newCartItem = new CartItem(item.id, item.title, item.price, cart);
//         cart.addToCart(newCartItem);
//     });
// });
//
// const itList = new ItemsList();
// const list = itList.fetchItems().then((value) => {
//     return itList.getItems()
// });
// // console.log(list);
//
// // console.log('itl',itList.fetchItems().then(() => itList.getItems()));
//
